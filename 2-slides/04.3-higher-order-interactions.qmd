...
library(tidyverse)
library(emmeans)
stress_data <- read_csv("_data/04-stress_data.csv")
head(stress_data) |> 
  knitr::kable()
...
```{r}
knitr::include_graphics("_images/046-three-way-decision-flowchart.png")
```
...
#| fig-align: center
#| out-width: 40%
knitr::include_graphics("_images/046-three-way-decision-flowchart-stress.png")
```
