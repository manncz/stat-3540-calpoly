...
You need local installations of both R (the
software) and RStudio (the interface for working in R). **Do not skip this step if you already have both R and RStudio installed on your computer**, as you need
...
![](images/01-rversion.png){fig-alt="A screenshot of what version of R should appear when you open RStudio. The version reads R version 4.6.1 (2026-06-24) -- 'Happy Hop'."}

You can also see the version right under the word "Console" or by running the following code in the console: `R.version`.

If the version **is not** 4.6.1 (like the image above), you need to update your
...
number. For example, the latest version of R as of August 2026 is 4.6.1 Happy Hop
...
# Install RStudio {#sec-installrstudio}
...
If you already have RStudio, **you need to double check if you have the most recent version.** You **will not** have access to the newest features for Quarto
...
# Ensure Quarto is Installed {#sec-quarto}
...
#  Create an R Project {#sec-rproject}
...
# Introduction to R and RStudio {#sec-intror}


## Navigating RStudio


-  📽 Video -- A Tour of RStudio: 

{{< video https://youtu.be/kfcX5DEMAp4?si=okE0641GKkf8ZrSJ >}}

-   [Download a "cheetsheet"](https://rstudio.github.io/cheatsheets/rstudio-ide.pdf) (easy reference page) for navigating the RStudio IDE.
...
- 📖 Reading: [R4DS: Basics of R](https://r4ds.hadley.nz/workflow-basics)

- 💻 Tutorial: [R Programming Basics](https://r-primers.andrewheiss.com/basics/02-programming-basics)
...
{{< video https://www.youtube.com/watch?v=tXZDoMlXfTE >}}
